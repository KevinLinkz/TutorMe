...
import com.example.me.ui.activity.BookingSchedule;

import java.util.ArrayList;
import java.util.List;

public class BasicActivity extends BookingSchedule {
public static int intRepeat = 0;
    @Override
    public List<? extends WeekViewEvent> onMonthChange(int newYear, int newMonth) {
        // Populate the week view with some events.
//        MyConstanta myConstanta = new MyConstanta(this,newYear,newMonth);
//        if (newYear == 2020){
//            intRepeat =0;
//        }
        List<WeekViewEvent> events = MyConstanta.events;
        intRepeat++;
