...
public class MyEvent implements Parcelable {
     ...
     */
    public MyEvent(long id, String name, int startYear, int startMonth, int startDay, int startHour, int startMinute, int endYear, int endMonth, int endDay, int endHour, int endMinute) {
        this.mId = id;
     ...
     */
    public MyEvent(long id, String name, String location, Calendar startTime, Calendar endTime) {
        this.mId = id;
        this.mName = name;
     ...
     * @param endTime The time when the event ends.
     */
    public MyEvent(long id, String name, Calendar startTime, Calendar endTime) {
    ...
    public static final Creator<MyEvent> CREATOR = new Creator<MyEvent>() {
        @Override
        public MyEvent createFromParcel(Parcel source) {
